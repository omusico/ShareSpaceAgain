 ...
 */
public class DatePickerFragmentBillsS extends android.support.v4.app.DialogFragment
    ...
    public void onDateSet(DatePicker view, int year, int month, int day) {
        ...
        Button DateButton = (Button) getActivity().findViewById(R.id.start_date_button_bills);
